...
// Upraszczamy kod, definiując dane w jednym miejscu
const navLinks = [
        ...
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerColumn}>
            ...
            <address className={styles.address}>
              <span>ul. 1 Maja 156, 25-646 Kielce</span>
              <a href="mailto:biuro@homevo.pl">biuro@homevo.pl</a>
              <a href="tel:+48503780700">+48 503 780 700</a>
            </address>
          </div>
